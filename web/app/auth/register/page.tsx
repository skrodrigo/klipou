    ...
    <main className="mx-auto flex min-h-dvh max-w-md flex-col px-8 py-8">
      <div className="flex flex-1 flex-col items-center justify-center">
        <Image
          ...
          quality={100} />
        <AuthRegisterForm />
        <span className="mt-4 text-foreground font-light">Tem conta? <Link href='/auth/login' aria-label="Login" className="underline text-muted-foreground">Login</Link></span>
      </div>
