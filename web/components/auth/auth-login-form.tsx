  ...
  return (
    <Form {...form}>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full max-w-xs mx-auto">
        ...
        <span className="text-foreground font-light w-full flex items-center justify-center">Não tem conta? <Link href='/auth/register' className="underline text-muted-foreground ml-1"> Registre-se</Link></span>
